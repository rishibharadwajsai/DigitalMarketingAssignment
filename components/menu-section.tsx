    ...
    items: [
      {
        ...
        price: 89,
        image: "/golden-crispy-samosas-with-mint-chutney.jpg",
        rating: 4.6,
        isVeg: true,
        isSpicy: true,
      },
      {
        ...
        price: 249,
        image: "/grilled-paneer-tikka-with-colorful-bell-peppers-on.jpg",
        rating: 4.8,
        isVeg: true,
        isSpicy: true,
      },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground text-pretty max-w-2xl mx-auto">
            From appetizers to desserts, every dish is prepared with authentic spices and fresh ingredients
          </p>
        </div>
                  ...
                  <Card key={item.id} className="group hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      <div className="space-y-3">
                        <div>
                          <h4 className="font-semibold text-lg text-card-foreground">{item.name}</h4>
